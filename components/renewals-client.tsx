...
export function RenewalsClient() {
  ...
  useEffect(() => { setItems(loadSubscriptions()); try { setIsDemo(Boolean(JSON.parse(localStorage.getItem(META_KEY) || "{}").demo)); } catch {} setReady(true); }, []);
